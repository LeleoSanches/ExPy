...
r/(2*\text{Rd})] - }\\
\pmb{\text{BesselI}[1, r/(2*\text{Rd})]*\text{BesselK}[1, r/(2*\text{Rd})]))/(2*\text{Rd}); }\\
\pmb{\text{Vme}[\text{r$\_$}, \text{R$\_$}, \text{P$\_$}] \text{:=} (6.4*G*((P*10{}^{\wedge}7)*R{}^{\wedge}3)*((1/2)*\text{Log}[(r/R){}^{\wedge}2
+ 1] + \text{Log}[r/R + 1] - }\\
\pmb{\text{ArcTan}[r/R]))/r; }\\
...
\pmb{\text{ErrorBar}[\text{Erro}[[i]]]\},\{i,24\}]\}, \text{PlotStyle}\to \text{Black}, \text{MeshStyle}\to \text{PointSize}[\text{Large}],}\\
